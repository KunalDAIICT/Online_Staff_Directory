...
export function FacultyCardApproved  ({ faculty }) {
  ...
  const handleDelete = (id) => async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/admin/deleteFaculty`, {
        method: "POST",
        headers: {
...
export function FacultyCardNotApproved ({ faculty }) {
  ...
  const handleApprove = (id) => async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/admin/approveFaculty`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + localStorage.getItem("token"),
...
export function AdminTab() {
  ...
  const fetchData = async () => {
    try {
      ...
      {
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/admin/allfaculties`, {
        method: "GET",
        headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
        },
...
export default function AdminHome() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`${process.env.REACT_APP_BASE_URL}/admin/isadmin`, {
          method: "GET",
          headers: {
